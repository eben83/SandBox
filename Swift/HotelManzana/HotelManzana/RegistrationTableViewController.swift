...
//  HotelManzana
//
//  Created by Eben Burger on 2019/10/01.
...
class RegistrationTableViewController: UITableViewController {
    ...
    // this property hold an array of Registration objects, default is empty
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        // number of static sections to be shown
        return 1
    }

    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // this counts the number of registrations and shows accordingly
    ...
    @IBAction func unwindFromAddRegistration(unwindSegue: UIStoryboardSegue) {
        //this unwinds from the add registration
