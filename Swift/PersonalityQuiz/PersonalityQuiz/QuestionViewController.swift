...
class QuestionViewController: UIViewController {
    ...
    @IBOutlet var multiLable2: UILabel!
    @IBOutlet var multiLable3: UILabel!
    @IBOutlet var multiLable4: UILabel!
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ResultsSegue" {
            ...
            func calculatePersonalityResult() {
                ...
                let responseTypes = UIWindow?.UIViewController as? ResultViewController.responses.map { $0.type }
                    //responses.map { $0.type }
                
                for responce in responseTypes {
                    let newCount: Int
                    
                    if let oldCount = frequencyOfAnswers[responce] {
                        newCount = oldCount + 1
                    } else {
                        newCount = 1
                    }
                    
                    frequencyOfAnswers[responce] = newCount
                    ...
                    resultAnswerLable.text = "you are a \(mostCommonAnswer.rawValue)!"
