...
for destinationVote in tripDestinationVotes {
    if destinationVote == .beach {
        beachVote += 1
    } else {
...
var marmotVotes = 0
var undesidedVotes = 0

for newMascotVote in mascotVotes {
    if newMascotVote == .salamander {
        salamanderVotes += 1
    } else if newMascotVote == .marmot {
        marmotVotes += 1
    } else {
        undesidedVotes += 1
    }
