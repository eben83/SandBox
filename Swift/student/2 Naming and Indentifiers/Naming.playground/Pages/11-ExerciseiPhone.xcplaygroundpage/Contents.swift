...
let TotaliPhoneStorage = iPhoneStorage * gigabyteToMegabyte
let totalUsedSpace = usedSpace * gigabyteToMegabyte
let availableSpace = ( TotaliPhoneStorage - totalUsedSpace )
let numberOfMins = availableSpace / oneMinVideo
