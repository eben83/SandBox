...
*/
func sentanceMessage(categoryOfThing: String, favorite: String) -> String{
    
    return "my favorite \(categoryOfThing) is \(favorite)"
}
 let sentance = sentanceMessage(categoryOfThing: "food", favorite: "cars")
sentance
...
sentanceMessage(categoryOfThing: "Car", favorite: "Ford")
sentanceMessage(categoryOfThing: "Drink", favorite: "cofee")
