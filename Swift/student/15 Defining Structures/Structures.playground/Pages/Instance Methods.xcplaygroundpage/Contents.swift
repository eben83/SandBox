...
struct TestRectangle {
    ...
    func area(_ testRectangle: TestRectangle) -> Bool {
        let areaOne = height * width
        let areaTwo = testRectangle.height * testRectangle.width
        return areaOne > areaTwo
    }

}

let areaOne = TestRectangle(width: 120, height: 120)
let areaTwo = TestRectangle(width: 100, height: 150)

areaOne.area(areaTwo)
areaTwo.area(areaOne)
