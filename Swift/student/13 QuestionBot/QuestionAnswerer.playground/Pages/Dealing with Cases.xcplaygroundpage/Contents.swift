...
let questionHello = "Hello"
let lowerQuest = questionHello.lowercased()

func responseTo(lowerQuest: String) -> String {
    
    if lowerQuest.hasPrefix("hello") {
