...
let positiveEmotion = "proud"
let negativeEmotion = "sad"

let sampleStory = " Today was a big day for \(name). They had finally saved up \(number) dollers and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). they were all out of \(noun)"
