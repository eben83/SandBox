...
let test = calculateArea(x: -1 , y: 0)
print(test)

let test2 = calculateArea(x: 2, y: 4)
print(test2)
/*:
...
func add(a: Int?, b: Int?) -> Int? {
    guard let numberOne = a, let numberTwo = b else {
    return nil
    }
...
let test3 = add(a: 0, b: 0)
print(test3)
let test4 = add(a: 2, b: 0)
print(test4)
let test5 = add(a: 2, b: 2)
print(test5!)
/*:
...
lastNameTextField.text = "Steven"
ageTextField.text = "28"

func createUser() -> User? {
    guard firstNameTextField.text != nil,
    lastNameTextField.text != nil,
        ageTextField.text != nil else {
           // print(firstNameTextField, lastNameTextField, ageTextField)
            return nil
    }
    
    let UserFirstName = String(firstNameTextField.text!)
    let UserLastName = String(lastNameTextField.text!)
    let UserAge = String(ageTextField.text!)
    
    print(UserAge, UserLastName, UserFirstName)// this line is printed
    return User(firstName: UserFirstName, lastName: UserLastName, age: UserAge)
