...
let sortednames = names.sorted { (firstName, secondName) -> Bool in
 ...
 */
let familyNames = ["Eben", "Tracy", "Jaco", "Candice", "Dennis", "Gary"]
 ...
 */
let sortedCollection2 = familyNames.sorted { (firstName, secondName) -> Bool in
    return firstName < secondName
}
 ...
 */
let sortedCollection3 = familyNames.sorted { (firstName, secondName) -> Bool in
    return firstName < secondName
}
