 ...
 */
var statesAndCapitals = ["Alabama": "Montgomery", "Alaska": "Juneau", "Arizona": "Phoenix"]
let homeState = ["Alaska": "Juneau"]

for home in statesAndCapitals {
    print(home)
    if homeState.keys == Array("Alaska") {
    }
}
