 ...
 */
var eben = User(name: "Eben", age: 35, weight: 66, activityLevel: 8)
print(eben)
...
var distanceInMeters = Distance(meters: 1600)
var distanceInFeet = Distance(feet: 5249.344)
var distanceInMiles = Distance(miles: 1)
 ...
 */
let distanceMile = Distance(miles: 1)
print(distanceMile)
let distaceFeet = Distance(feet: 5249.344)
print(distanceInFeet)
/*:
