 ...
 */
var somePlace = GPS(latitude: 51.514994, longitude: 0.125226)
print(somePlace)
...
var favoriteBook = Book(title: "never", author: "John", pages: 124, price: 24.76)
print(favoriteBook)
...
struct Height {
    ...
    init(hieghtInCentimeters: Double) {
 ...
 */
let someHeight = Height(hieghtInCentimeters: 65)
print(someHeight)
