...
var runnignChallenge = [String]()
walkingChallenge += ["walk 1 mile", "walke 2 miles"]
runnignChallenge += ["run 3 miles", "run 5 miles"]
 ...
 */
var challenges = [walkingChallenge, runnignChallenge]
...
userChallenges.append("walk 2 days")
userChallenges.append("Walking 10 miles")
userChallenges.removeAll()
...
if userChallenges.isEmpty {
    print("Please can you select a challenge")
} else if userChallenges.count == 1 {
    print("The challenge you have chosen \(userChallenges)")
} else {
    print("You have multiple chalenges")
}
